...
export async function POST(request: NextRequest) {
  try {
    ...
    // Ellenőrizzük, hogy már létezik-e jelenléti adat ehhez az órához és dátumhoz
    ...
    if (!existingAttendance.empty) {
      return NextResponse.json({ error: 'Ehhez az órához már rögzítve van a jelenlét!' }, { status: 409 })
    }
