...
class ParentDataCache {
  ...
  setSubmittedExcuses(childId: string, excuseIds: string[]): void {
    this.set(`excuses_${childId}`, excuseIds, 10 * 60 * 1000) // 10 perc cache igazolasokhoz
  }
